...
const SearchUser = ({ handleSearchChange }: any) => {
    ...
    return (
        <div className="max-w-xs px-4 text-base">

            <div className="label-button flex bg-white items-center gap-1 px-2 border rounded-lg shadow-sm"
            >
                        ...
                        <ul ref={listboxRef} className="absolute w-full mt-3 overflow-y-auto bg-white border rounded-md shadow-sm max-h-64" role="listbox">
                            <li id="li-alert" className="hidden px-3 py-2 text-center text-gray-600">Not results available</li>
                            {
                                menuItems.map((el, idx) => (
                                    ...
                                    >
                                        <img src={el.image} className="w-6 h-6 rounded-full" />
