...
const SideNav = ({ open }: any) => {
    return (
        ...
        <nav className={`h-screen overflow-hidden  ${open ? "w-64" : "w-0"} md:flex text-[aliceblue] bg-gray-900`}>

            <div className="flex flex-col border-r border-gray-800">
                <aside className="flex flex-col w-64 h-screen py-8 bg-white dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <div className="h-screen px-5 py-8 overflow-y-auto bg-white  sm:w-64 w-64 dark:bg-gray-900 dark:border-gray-700">
