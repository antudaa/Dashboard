...
const TopNav = ({ toggle }: any) => {
    return (
        <div className="flex items-center justify-between flex-shrink-0 h-16 px-8 bg-[aliceblue] ">
            ...
            <div className="flex ml-4">
                <div>
                    <nav className="contents">
                        <ul className="flex items-center lg:mr-6 xl:mr-8">
                            ...
                            <Image onClick={toggle} className="cursor-pointer flex md:hidden m-6" src={Hamburger} width={20} height={20} alt="Image not Found" />
                        </ul>
                    </nav>
                </div>
                <a href="" className="mr-4 lg:mr-6 xl:mr-8 flex items-center justify-center h-10 px-4 ml-2 text-sm font-medium rounded ">
                ...
                <button className="bg-black hover:bg-gray-700 text-white  px-2 rounded">Profile</button>
            </div>
        </div>
