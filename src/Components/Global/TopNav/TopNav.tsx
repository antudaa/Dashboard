...
// Company Logo for Large Devices
import logo from "@/Assets/Icons/logobgwhite.png";
// Company Short Logo For Moblie Device
import shortLogo from "@/Assets/Icons/shortlogobgwhite.png";
...
const TopNav = ({ toggleNav, open }: any) => {
    ...
    return (
        <div className="flex items-center justify-between px-8 bg-[aliceblue] text-gray-800 w-full shadow-lg py-2">
            ...
            <Image className="cursor-pointer hidden md:block" src={logo} width={130} height={60} alt="Image not Found" />
            <Image className="cursor-pointer block md:hidden" src={shortLogo} width={40} height={20} alt="Image not Found" />
            {
                ...
                <div>
                    <nav className="contents">
                        <ul className="flex items-center lg:mr-6 xl:mr-8">
                            <li className="p-1">
                                <Link href="#" className="inline-block rounded-full border p-2 hover:shadow-lg hover:border-opacity-0 duration-200 hover:-translate-y-0.5">
